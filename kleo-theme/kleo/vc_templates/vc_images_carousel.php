...
<div class="<?php echo esc_attr( $css_class ); ?>">
	<div class="kleo-carousel-items<?php echo esc_attr( $el_animation ); ?>" <?php echo kleo_get_attributes_string( $data_attr ); ?>>
		<div class="kleo-carousel">
			...
			if ( is_array( $images ) ) :
				...
				<?php else:
					echo '<a class="kleo-gallery-img">' . trim( $thumbnail ) . '</a>';
				endif; ?>
