...
<?php if ( have_posts() ) : ?>
	...
	$category = '';
	if ( is_tax( apply_filters( 'kleo_portfolio_cat_taxonomy', 'portfolio-category' ) ) ) {
		$category = get_queried_object()->slug;
	}

	echo kleo_portfolio_items( $display_type, $title_style, $columns, null, 'yes', $show_filter, $excerpt, $img_width, $img_height, $category );
	?>
