	...
	class kleo_walker_nav_menu extends Walker_Nav_Menu {
		...
		public static function fallback( $args ) {
			if ( current_user_can( 'manage_options' ) ) {
				...
				if ( $container ) : ?>
					<<?php echo esc_attr( $container ); ?><?php echo isset( $container_id ) && $container_id ? ' id="' . esc_attr( $container_id ) . '"' : ''; ?><?php echo isset( $container_class ) && $container_class ? ' class="' . esc_attr( $container_class ) . '"' : ''; ?>>
				<?php endif; ?>

				<ul<?php echo isset( $menu_id ) && $menu_id ? ' id="' . esc_attr( $menu_id ) . '"' : ''; ?><?php echo isset( $menu_class ) && $menu_class ? ' class="' . esc_attr( $menu_class ) . '"' : ''; ?>>
					<li><a href="<?php echo esc_url( admin_url( 'nav-menus.php' ) ); ?>"><?php esc_html_e( 'Add a menu', 'kleo' ); ?></a></li>
				</ul>
