...
function kleo_bp_mobile_notify() {
    ...
    $url = bp_loggedin_user_domain() . bp_get_notifications_slug();
    ...
    ?>
    <a title="<?php esc_attr_e( 'View Notifications', 'kleo' ); ?>" class="notify-contents" href="<?php echo esc_url( $url ); ?>">
        <span class="notify-items sq-notify-mobile">
            <i class="icon-<?php echo esc_attr( $icon ); ?>"></i>
            <span class="kleo-notifications <?php echo esc_attr( $alert ); ?>">
