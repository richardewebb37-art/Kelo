...
if ( isset( $shortcode_atts['bg_type'] ) ) : ?>
    <div <?php echo implode( ' ', $wrapper_attributes ); ?>>
        <div class="section-container container<?php echo trim($inner_container != 'yes' ? '-full' : ''); ?>">
        	<?php echo wpb_js_remove_wpautop( $content ); ?>
        </div>
        <?php echo trim( $bg_video ); ?>
    </div>
<?php else : ?>
    <section class="<?php echo esc_attr( implode( ' ', $section_classes ) ); ?>" style="<?php echo esc_attr($my_style); ?>" <?php echo implode( ' ', $container_attributes ); ?>>
		<div class="section-container container<?php echo trim($inner_container != 'yes' ? '-full' : ''); ?>">
			<div <?php echo implode( ' ', $wrapper_attributes ); ?>>
				<?php echo wpb_js_remove_wpautop( $content ); ?>
			</div>
