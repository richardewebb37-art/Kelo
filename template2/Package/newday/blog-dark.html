...
<div class="wrap">
	<div class="container">
		<div id="header">
					...
					<div class="col-md-8 col-sm-7 col-xs-12">
						<div class="header-info pull-right">
							...
							<div class="header-info-login">
								<a href="#" class="header-btn-signin"><span class="lnr lnr-user"></span> Sign In</a>
			...
			<nav class="main-nav">
				<ul class="main-menu">
						...
						<div class="mega-menu">
							<div class="mega-menu-tab-slider">
								<div class="event-slider box-post-slider">
									<h2 class="title home-title">Technology</h2>
									<div class="current-event">
										<div class="event-tab-list">
											<ul class="nav nav-tabs" role="tablist">
												<li role="presentation" class="active"><a href="#post-latest" aria-controls="post-latest" role="tab" data-toggle="tab">Latest news</a></li>
												<li role="presentation"><a href="#post-trending" aria-controls="post-trending" role="tab" data-toggle="tab">Trending</a></li>
												<li role="presentation"><a href="#post-popular" aria-controls="post-popular" role="tab" data-toggle="tab">Most popular</a></li>
					...
					<li><a href="tralvel.html">Travel</a></li>
		...
		<!-- End Header -->
		<div id="content">
			<div class="content-blog-dark">
				<div class="item-post-list">
					<div class="post-thumb">
						<a href="#"><img alt="" src="images/blog/dark1.jpg"></a>
					</div>
					<div class="post-list-info">
						<ul class="post-list-info-author list-inline">
							<li>post by: 7uptheme</li>
							<li>FEBRUARY 19, 2016</li>
						</ul>
						<h2 class="title"><a href="#">Praesent justo dolor, lobortis </a></h2>
						<p class="desc">Dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cumt sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nulla onsequat mas quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget. Nemo enim ipsam voluptatem quia voluptas sit pernatur aut odit aut fugit, sed quia consequuntur magni dolores.</p>
						<a class="btn-read-more" href="#">Read More <span class="lnr lnr-chevron-right"></span></a>
				...
				<div class="item-post-list">
					<div class="post-thumb">
						<a href="#"><img alt="" src="images/blog/dark2.jpg"></a>
					</div>
					<div class="post-list-info">
						<ul class="post-list-info-author list-inline">
							<li>post by: 7uptheme</li>
						...
						<h2 class="title"><a href="#">Grande Highest Mountain in the </a></h2>
						<p class="desc">Dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cumt sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nulla onsequat mas quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget. Nemo enim ipsam voluptatem quia voluptas sit pernatur aut odit aut fugit, sed quia consequuntur magni dolores.</p>
						<a class="btn-read-more" href="#">Read More <span class="lnr lnr-chevron-right"></span></a>
						<div class="post-list-tags">
							<a href="#">Asian</a>
				...
				<div class="item-post-list">
					<div class="post-thumb">
						<a href="#"><img alt="" src="images/blog/dark3.jpg"></a>
					</div>
					<div class="post-list-info">
						<ul class="post-list-info-author list-inline">
							<li>post by: 7uptheme</li>
						...
						<h2 class="title"><a href="#">Best Photographers working with Wild Animals</a></h2>
						<p class="desc">Dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cumt sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nulla onsequat mas quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget. Nemo enim ipsam voluptatem quia voluptas sit pernatur aut odit aut fugit, sed quia consequuntur magni dolores.</p>
						<a class="btn-read-more" href="#">Read More <span class="lnr lnr-chevron-right"></span></a>
						<div class="post-list-tags">
							<a href="#">Travel</a>
				...
				<div class="item-post-list">
					<div class="post-thumb">
						<a href="#"><img alt="" src="images/blog/dark4.jpg"></a>
					</div>
					<div class="post-list-info">
						<ul class="post-list-info-author list-inline">
							<li>post by: 7uptheme</li>
				...
				<!-- End Item -->
				<ul class="post-paginav">
					<li><a class="current-page" href="#">1</a></li>
					<li><a href="#">2</a></li>
					<li><a href="#">3</a></li>
					<li><a class="next-page" href="#">Next <span class="lnr lnr-chevron-right"></span></a></li>
				</ul>
			</div>	
		</div>
		<!-- End Content -->
